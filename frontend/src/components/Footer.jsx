    ...
    <footer className="w-full flex flex-col">
      ...
      <div className="w-full bg-black py-12 px-4 text-center">
        ...
        <button
          ...
          className="inline-block bg-white text-black hover:bg-gold transition-colors duration-300 font-bebas text-xl md:text-2xl tracking-widest uppercase py-3 px-8 cursor-pointer"
        >
          GET IN. NOW.
        </button>
      </div>
